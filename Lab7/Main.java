...
class Main {
    ...
    public static void main(String[] args) {
        ...
        while (running) {
            ...
            switch (userChoice) {
                ...
                case 5 -> ViewValidHouseOffersTownAndAreaFilter(
                        offers,
                        scanner);
                case 6 -> ViewValidFlatOffersWithTownPriceAndFloorFilter(
                        offers,
                        scanner);
    ...
    static void AddHouseOffer(Offers offers, Scanner scanner) {
        ...
        String buildingNumber = getStringInputFromUser(
        ...
        double buildingArea = getDoubleInputFromUser(
        ...
        LocalDate offerValidityDate = LocalDate.parse(
                getStringInputFromUser("Enter offer validity date: ", scanner));
    ...
    static void AddFlatOffer(Offers offers, Scanner scanner) {
        ...
        String buildingNumber = getStringInputFromUser(
                "Enter building number: ",
                scanner);
        String flatNumber = getStringInputFromUser(
                "Enter flat number: ",
                scanner);
        String town = getStringInputFromUser("Enter town name: ", scanner);
        String postCode = getStringInputFromUser("Enter post code: ", scanner);
    ...
    static void ViewValidHouseOffers(Offers offers) {
        ArrayList<Building> validBuildingOffers = offers.filter(
                building -> building instanceof House && building.isValidOffer());
    ...
    static void ViewvValidFlatOffers(Offers offers) {
        ArrayList<Building> validBuildingOffers = offers.filter(
                building -> building instanceof Flat && building.isValidOffer());
        for (Building building : validBuildingOffers) {
            System.out.println(building);
        }
    }

    static void ViewValidHouseOffersTownAndAreaFilter(
            Offers offers,
            Scanner scanner) {
        scanner.nextLine();
        String town = getStringInputFromUser("Enter town name: ", scanner);
        double buildingArea = getDoubleInputFromUser(
                ...
                scanner);
        ArrayList<Building> validBuildingOffers = offers.filter(
                building -> building instanceof House &&
                        building.isValidOffer() &&
                        building.getTown().equals(town) &&
    ...
    static void ViewValidFlatOffersWithTownPriceAndFloorFilter(
            Offers offers,
            Scanner scanner) {
        scanner.nextLine();
        String town = getStringInputFromUser("Enter town name: ", scanner);
        ...
        int floorNumber = getIntInputFromUser("Enter floor number: ", scanner);
        ArrayList<Building> validBuildingOffers = offers.filter(
                building -> building instanceof Flat &&
                        building.isValidOffer() &&
                        building.getTown().equals(town) &&
